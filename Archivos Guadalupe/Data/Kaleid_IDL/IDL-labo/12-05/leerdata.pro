pro leerdata  ;, tek=tek, Rp=Rp
 ; leo y salvo t,ch1,ch2,Rm,I,V y Xi,Xf,Rp  para los cuales salve fueron
 ;  solo estos porque tienen rampa y un pulso

data=['tek0005ALL.csv','tek0006ALL.csv','tek0008ALL.csv','tek0009ALL.csv',$
'tek0011ALL.csv','tek0012ALL.csv'] 

 a=[24,22,50,55,63,67]    ;tek05,06,08,09,11,12
 b=[920,920,800,800,810,810]
 Rpatron=[6000,2000,2000,2000,2000,2000]
...
restore,filename='guadatemplate.sav'
 ...
 FOR N=0 ,n_elements(data)-1 DO BEGIN
  ...
  titulo=(strmid(data(N),0,7)+'_1205')[0]
