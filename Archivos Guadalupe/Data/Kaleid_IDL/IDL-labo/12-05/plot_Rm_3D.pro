...
;--------------Rm05-06-08-09-11-12
 ...
 yrange=[0,10000],xrange=[0.000001,0.02],background=16777215,$
 color=0,/nodata
...
;stop
 ...
 FOR M=0, n_elements(data)-1 do begin
   ;nume=string(M)
 restore,data(M)
 oplot,I,Rm,color=0,psym=2,symsize=0.2
 XYOUTS,300,215,'**',color=0,/device
 XYOUTS,320,215,'tek_r2-17',color=0,/device
 ENDFOR
 fila='Rm-I_superp-5-6-8-9-11-12+p 2-3-4-10-13-14-15-16-17'
