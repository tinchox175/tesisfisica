...
files = ['/criostato/Archivos/iv/1312/iv-x5-w1-14K-2nplc.csv',]
for i in files:
    archivo_actual = '/criostato/Archivos/iv/1012/iv(ac20hz)-x5-w1-95K.csv'
    archivo_actual = i
    ...
    # ax.scatter(vin1, iin1, lw=4, c='#4c86f0')
    # Create a colormap from light blue to '#4c86f0'
    sc = ax[0].scatter(vin1, iin1, s=30, c=time, cmap=cmap)
    ax[1].scatter(vin1[:-1], gam1, s=30, c=time[:-1], cmap=cmap)
