...
dir = 'c:/tesisfisica/criostato/Archivos/X5/rampas/'
...
for filename in rampas:
    ...
    if filename == 'c:/tesisfisica/criostato/Archivos/X5/rampas/RampaRdeT711.csv':
        r1 = r1[:]
        continue
    elif filename == 'c:/tesisfisica/criostato/Archivos/X5/rampas/RampaRdeT811.csv':
        r1 = r1[:1512]
        T = T[:1512]
        # continue
    elif filename == 'c:/tesisfisica/criostato/Archivos/X5/rampas/RampaRdeT1212.csv':
        r1 = r1[:1850]
        T = T[:1850]
        filename = 'c:/tesisfisica/criostato/Archivos/X5/rampas/RampaRdeT1212 I=1 mA.csv'
        continue
    elif filename == 'c:/tesisfisica/criostato/Archivos/X5/rampas/RampaRdeT1212 I=10 mA.csv':
        r1 = r1[1850:]
        T = T[1850:]
        continue
    elif filename == 'c:/tesisfisica/criostato/Archivos/X5/rampas/RampaRdeT1312 I=0,1 mA.csv':
        # pass
        continue
    elif filename == 'c:/tesisfisica/criostato/Archivos/X5/rampas/RampaRdeT1712b.csv':
        pass
        # continue
    elif filename == 'c:/tesisfisica/criostato/Archivos/X5/rampas/RampaRdeT1812.csv':
        pass
        # continue
    mk = next(marker)
    ax.scatter(T, r1/41, marker=mk, s=10, label=f'Medición {filename.split("/")[-1].split("T")[-1].split('.')[0]}') 
    # ax2.scatter(T, r1, marker=mk, s=10, label=f'Medición {filename.split("/")[-1].split("T")[-1].split('.')[0]}')
    #dividir por 41 la r  
...
ax2.set_yticks([0e-2, 2e-2, 4e-2, 6e-2, 8e-2, 1e-1, 1.2e-1, 1.4e-1, 1.6e-1, 1.8e-1, 2e-1])
# ax.set_xlim(10,100)
ax.set_xlabel('T (K)')
