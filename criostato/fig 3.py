...
fig, (ax_res) = plt.subplots(1, 1, figsize=(4, 3), dpi=450)
...
try:
    ...
    ax_res.legend(handles, labels, frameon=False)
...
plt.show()
save_figure_data(fig, filename="Fig 3")
